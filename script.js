...
const arvotut = [img1,img2,img3,img4];
...
function arpoo(){
    ...
    if (locks[1] == 0){
        ...
        img2.src = "images/apple.png"/*`images/${[images[luku2]]}`;// luvut väliltä 0-4!*/
    }
    if (locks[2] == 0){
        let luku3 = Math.floor((Math.random() * [images.length]) );
        img3.src = "images/apple.png"/*`images/${[images[luku3]]}`;// luvut väliltä 0-4!*/
    }
    if (locks[3] == 0){
        let luku4 = Math.floor((Math.random() * [images.length]) );
        img4.src = "images/apple.png"/*`images/${[images[luku4]]}`;// luvut väliltä 0-4!*/
    }
}
...
function tarkistaVoitto(){
    if (arvotut[0] == images[0]){
        voitto = 6 * panos;
        tulostaVoitto();
    } /*
    else if (slots[0] == images[1] && slots[1] == images[1] && slots[2] == images[1] && slots[3] == images[1]){
        voitto = 3 * panos;
        tulostaVoitto();
    }
    else if (slots[0] == images[2] && slots[1] == images[2] && slots[2] == images[2] && slots[3] == images[2]){
        voitto = 10 * panos;
        tulostaVoitto();
    }
    else if (slots[0] == images[3] && slots[1] == images[3] && slots[2] == images[3] && slots[3] == images[3]){
        voitto = 4 * panos;
        tulostaVoitto();
    }
    else if (slots[0] == images[4] && slots[1] == images[4] && slots[2] == images[4] && slots[3] == images[4]){
        voitto = 5 * panos;
        tulostaVoitto();
    }*/
    else {
